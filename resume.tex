...
\begin{textblock}{11.35}(9.25, 1)
	...
	\vspace{-\baselineskip}
	\EduStatement{01/2018}{06/2018}{Norwegian University of Science and Technology}{Exchange Semester - International Profile}{Software Engineering}
	\vspace{-\baselineskip}
	...
	\begin{ExpStatement}{05/2017}{12/2017}{Desjardins, General Insurance Group}{Database Analyst - Research and Development}
		\item Bulk extraction from indemnization agent notes using NLP approaches (Python)
		\item Documentation generator (similar to \textit{Doxygen}) using \texttt{XSD}, \texttt{XML} and \texttt{XSL} for \texttt{SAS}
		\item Redesign of the data extraction pipeline used to create fraud models (SAS)
	\end{ExpStatement}
	...
	\begin{ExpStatement}{05/2013}{12/2016}{}{Actuarial Analyst - Property Ratemaking}
		...
		\item Production of 2017 Budget's assumptions for newly acquired State Farm's portfolio
