...
\newcommand{\cvpersonnalitytype}{INTJ-T}
\newcommand{\cvpersonnalitytypeurl}{https://www.16personalities.com/intj-personality}
...
\begin{textblock}{7}(0.5, 3.75)
	...
	\begin{table}
		\begin{tabularx}{7cm}{cX}
			...
			\icon{\faGroup}&{\large\textbf{Personnality Type: \href{\cvpersonnalitytypeurl}{\cvpersonnalitytype}}}\\
		\end{tabularx}
	\end{table}
